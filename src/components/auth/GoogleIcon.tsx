...
export function GoogleIcon({ className = 'h-5 w-5' }: GoogleIconProps) {
  return (
    <svg viewBox="0 0 48 48" className={className} aria-hidden="true">
      ...
      <path
        fill="#4CAF50"
        d="M24 44c5.5 0 10.4-1.9 14.1-5.1l-6.5-5.5c-2 1.5-4.7 2.6-7.6 2.6-5.2 0-9.6-3.3-11.3-8l-6.6 5.1C9.9 39.7 16.4 44 24 44Z"
      />
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4.1 5.4l6.5 5.5C41.4 35.6 44 30.2 44 24c0-1.2-.1-2.4-.4-3.5Z"
      />
    </svg>
  )
}
